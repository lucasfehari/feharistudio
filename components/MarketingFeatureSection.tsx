      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        >
          {/* Background Image Placeholder 
              NOTA PARA O DESENVOLVEDOR: Substitua a URL abaixo pela foto do seu time de marketing com camisas da Fehari.
          */}
          <div 
          ...
          <div className="relative z-10 h-full flex flex-col justify-between p-8 md:p-16">
            ...
            <div className="max-w-3xl">
              ...
              >
                Precisa de Marketing? <br />
                A Fehari faz sua empresa <br />
                <span className="text-gray-400">vender mais.</span>
              </motion.h2>
              ...
              >
                <Button className="bg-accent hover:bg-accent-secondary text-white border-none rounded-full px-8 py-6 text-lg font-medium">
              ...
              >
                <div className="flex flex-col items-end">
                  <div className="flex items-center gap-3 mb-1">
                    <span className="font-display font-bold text-2xl text-white tracking-tight">FEHARI</span>
